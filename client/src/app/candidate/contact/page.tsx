...
const contactCards = [
  {
    ...
    subtext: "24/7 candidate assistance team",
  },
  {
    icon: Headphones,
    title: "Candidate Support",
    detail: "candidates@nuvora.com",
    subtext: "Application & alert queries",
  },
  {
    icon: MapPin,
...
const faqs = [
  {
    question: "How do Candidate Instant Job Alerts work?",
    answer:
      "When new jobs matching your subscribed companies or preferences are published, you will automatically receive instant or daily email notifications.",
  },
  {
    question: "How do I track my application status?",
    answer:
      "Navigate to Applied Jobs in your dashboard to view real-time updates (Applied, Under Review, Shortlisted, Interview, Hired).",
  },
  {
    question: "How do I update my profile details?",
    answer:
      "Go to Profile Settings to update your resume, headline, skills, education, and experience details anytime.",
  },
];
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Have a question or need assistance with your job applications? Reach out to our support team."
        breadcrumbs={[{ label: "Candidate", href: "/candidate" }, { label: "Contact" }]}
      />
      ...
      <div className="grid lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-7 p-6 sm:p-8 rounded-3xl border border-border/60 bg-card shadow-sm space-y-6">
          <div className="space-y-1">
            <h2 className="text-xl font-bold text-foreground">Send Support Message</h2>
